...
function TBL_Create(szTitle, aArrayHeader)
{
	var obj = new Object();
	...
	{
		var szTmp = "<br><table border=" + this.ulBorderSize + " cellSpacing=0 cellPadding=0 bordercolor=#999999>";
		var ulCount = 0;
		var szColor = "";

		TBL_BuildTitle(szTitle)(this.szTitle);
